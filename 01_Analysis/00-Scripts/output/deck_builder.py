...
_SECTION_MAP = {
    ...
    "ics": "ics",
    "txn": "transaction",
    "txn-general": "transaction",
    "txn-merchant": "transaction",
    "txn-mcc_code": "transaction",
    "txn-business": "transaction",
    "txn-personal": "transaction",
    "txn-competition": "transaction",
    "txn-financial": "transaction",
    "txn-ics": "transaction",
    "txn-campaign": "transaction",
    "txn-branch": "transaction",
    "txn-transaction": "transaction",
    "txn-product": "transaction",
    "txn-attrition": "transaction",
    "txn-balance": "transaction",
    "txn-interchange": "transaction",
    "txn-rege": "transaction",
    "txn-payroll": "transaction",
    "txn-relationship": "transaction",
    "txn-segment": "transaction",
    "txn-retention": "transaction",
    "txn-engagement": "transaction",
    "txn-executive": "transaction",
    "m1": "transaction",
    "m2": "transaction",
    "m3": "transaction",
    "m4": "transaction",
