...
# ===========================================================================
# One rich, self-contained cell that tells the full competitive story with
# wallets + P2P removed but BNPL retained. Six panels:
#
...
if not _BOOT_OK:
    ...
    print("=" * 72)
    print(f"  Excluded wallets + P2P        : {CORE_EXCLUDED_TXNS:,} txns "
          f"({CORE_EXCLUDED_PCT:.1f}%)")
    ...
    fig1.text(0.5, 0.96, CORE_SCOPE_NOTE,
    ...
    fig2.text(0.5, 0.97, CORE_SCOPE_NOTE,
              ha='center', fontsize=13, color=GEN_COLORS['muted'], style='italic')
    plt.tight_layout()
    ...
    ax3.text(0.3, 0.7, CORE_SCOPE_NOTE,
    ...
    if 'year_month' in core_txns.columns and core_txns['year_month'].notna().any():
        ...
        if len(monthly) >= 2:
            ...
            fig4.text(0.5, -0.02, CORE_SCOPE_NOTE, ha='center',
                      fontsize=13, color=GEN_COLORS['muted'], style='italic')
    ...
    if 'year_month' in core_txns.columns and core_txns['year_month'].notna().any():
        ...
        if len(months_sorted) >= 6:
            ...
            fig5.text(0.5, -0.02,
                      ...
                      f"Previous: {', '.join(str(m) for m in prev_3)}.  {CORE_SCOPE_NOTE}",
            ...
            fig6.text(0.5, -0.02,
                      ...
                      f"Min floor: {min_floor} accts across both windows.  {CORE_SCOPE_NOTE}",
                      ha='center', fontsize=12, color=GEN_COLORS['muted'], style='italic')
            plt.tight_layout()
