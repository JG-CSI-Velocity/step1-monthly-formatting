# ===========================================================================
# MERCHANT KPI DASHBOARD: Key Metrics at a Glance (Conference Edition)
# ===========================================================================
...
kpi_data = [
    {
        ...
        'value': f"{len(merch_agg):,}",
        'sub': 'unique consolidated names',
        'color': GEN_COLORS['primary'],
    },
    {
        'label': 'Top 10 Share',
        'value': f"{top10_share_m:.1f}%",
        'sub': 'of all transactions',
        'color': GEN_COLORS['info'],
    },
    {
        'label': 'Avg Txns / Merchant',
        'value': f"{merch_agg['txn_count'].mean():.0f}",
        'sub': f"median {merch_agg['txn_count'].median():.0f}",
        'color': GEN_COLORS['success'],
    },
    {
        'label': '#1 Merchant',
        'value': f"{merch_agg.iloc[0]['txn_pct']:.1f}%",
        'sub': merch_agg.iloc[0]['merchant_consolidated'][:28],
